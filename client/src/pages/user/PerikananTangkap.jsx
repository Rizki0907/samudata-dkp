  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-8">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-foreground mb-4">Volume Tangkapan Berdasarkan Komoditas Terbanyak</h3>
        {stats.komoditas.length > 0 ? (
          <ReactECharts 
            option={komoditasChartOption} 
          ...
          <div className="h-[400px] flex items-center justify-center text-muted-foreground bg-muted/20 rounded-xl border border-dashed border-border">
            Belum ada data komoditas untuk divisualisasikan.
          </div>
        )}
      </div>
