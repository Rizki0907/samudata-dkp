        ...
        <div className="flex items-center gap-2">
          ...
          {!hideDefaultExport && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-secondary text-white dark:text-black rounded-xl hover:opacity-90 transition-opacity text-sm font-medium"
            >
