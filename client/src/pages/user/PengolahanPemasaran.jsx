...
export default function PengolahanPemasaran() {
  ...
  // Mengambil pilihan Kab/Kota dari Master Data.
  ...
  // Menyaring data sesuai filter aktif (Tahun & Kab/Kota) dan menempatkan data
  // yang paling baru diperbarui di urutan atas.
  ...
  // Kategori aktif untuk grafik "Jenis Detail Kegiatan" ditentukan oleh toggle
  // Pengolahan/Pemasaran di dalam kartu grafik itu sendiri.
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Filter utama: hanya Tahun dan Kab/Kota */}
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            ...
            {/* Filter tabel: hanya Tahun dan Kab/Kota */}
